...
WeChatService::WeChatService(io_service &msg_iosev, io_service &fun_iosev):message_iosev(msg_iosev), Funtion_iosev(fun_iosev),
                             ...
                             AllCmd(90),myuserservice(this,AlwaysUserMap)
{

       WeChatfuntions.push_back( boost::bind(&UserService::SightUp ,myuserservice,_1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back( boost::bind(&UserService::CheackLogin ,myuserservice,_1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back( boost::bind(&WeChatService::SendIndiviMsg, this, _1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back(boost::bind(&UserService::AddGround,myuserservice,_1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back(boost::bind(&UserService::DeleteGround,myuserservice,_1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back(boost::bind(&UserService::AddFriend,myuserservice,_1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back(boost::bind(&UserService::DeleteFriends,myuserservice,_1,_2,_3,_4,_5,_6));
        WeChatfuntions.push_back(boost::bind(&UserService::FindFriendsMsg,myuserservice,_1,_2,_3,_4,_5,_6));
